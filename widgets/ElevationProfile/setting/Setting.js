    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      setConfig: function (config) {
        ...
        setTimeout(function () {
          ...
          helpLink[0].href = this.configWindow.esri._appBaseUrl + 'widgets/ElevationProfile/help/elevationprofile_Help.htm';
        ...
        if(config.width){
          this.widthTextBox.set('value', config.width);
        }
        this.chartRenderingOptions = lang.mixin({}, config.chartRenderingOptions);
      },

      getConfig: function () {
        this.config.width = this.widthTextBox.get('value');
        return this.config;
      },
